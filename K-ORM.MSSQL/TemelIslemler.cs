    ...
    public class TemelIslemler<T> : VeriIslemleri where T : class
    {
        ...
        protected SqlParameter[] ParametreOlustur(T nesne)
        {
            ...
            foreach (var prop in nesne.GetType().GetProperties())
            {
                ...
                else if(parameter.Value == null && parameter.SqlDbType == SqlDbType.NVarChar)
                {
                    parameter.DbType = DbType.String;
        ...
        protected IEnumerable<T> ListeyeCevir(DataTable dt)
        {
        ...
        /// <returns>List<typeparamref name="T"/> tipinde değer döndürür</returns>
        public IEnumerable<T> VeriGetirSQL(string sql)
        {
            DataTable dataTable = VIVeriGetir(sql);
            IEnumerable<T> liste = ListeyeCevir(dataTable);
            return liste;
        }
        ...
        /// </summary>
        /// <returns>List<typeparamref name="T"/> tipinde değer döndürür</returns>
        public IEnumerable<T> VeriGetir()
        {
        ...
        /// <returns>List<typeparamref name="T"/> tipinde değer döndürür</returns>
        public IEnumerable<T> VeriGetir(string sart)
        {
        ...
        /// <returns>List<typeparamref name="T"/> tipinde değer döndürür</returns>
        public IEnumerable<T> VeriGetir(string sart, string istenen)
        {
        ...
        {
            List<T> liste = VeriGetir(sart).ToList();
        ...
        /// <returns>List<typeparamref name="T"/> tipinde değer döndürür</returns>
        public IEnumerable<T> ProsedureCagir(string prosedureAdi, string parametreBildirisi, SqlParameter[] parametreler)
        {
